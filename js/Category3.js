...
function category3ContentPart_1() {
  ...
  let category3ContentPart_1 = document.getElementById('category3ContentPart_1');
  ...
  for(let index=0; index<=NUMBER_OF_IMAGES; index++) {
    ...
    category3ContentPart_1.appendChild(div);

  }
})

};
category3ContentPart_1()

function category3ContentPart_2() {
  ...
  let category3ContentPart_2 = document.getElementById('category3ContentPart_2');
  ...
  for(let index=0; index<=NUMBER_OF_IMAGES; index++) {
    ...
    category3ContentPart_2.appendChild(div);

  }
})

};
category3ContentPart_2()
...
function category_3() {
   fetch("http://localhost:8000/api/v1/titles/?actor=&actor_contains=&company=&company_contains=&country=&country_contains=&director=&director_contains=&format=json&genre=Adventure&genre_contains=&imdb_score=&imdb_score_max=&imdb_score_min=&lang=&lang_contains=&max_year=&min_year=&rating=&rating_contains=&sort_by=-imdb_score&title=&title_contains=&writer=&writer_contains=&year=")
    ...
    let category_3 = document.getElementById('category_3');
    const NUMBER_OF_IMAGES = 3;
    for(let index=0; index<=NUMBER_OF_IMAGES; index++) {
        let td = createTd();
        let affiche = cleanString(json.results[index].image_url);
        ...
        let a = createA();
        a.className = "button";
        a.setAttribute("href","#popup"+index+30);

        a.appendChild(createImgPopup(affiche, title));
        div.appendChild(a);
        td.appendChild(div);

        category_3.appendChild(td);
...
function category_3_Part2() {
   fetch("http://localhost:8000/api/v1/titles/?actor=&actor_contains=&company=&company_contains=&country=&country_contains=&director=&director_contains=&format=json&genre=Adventure&genre_contains=&imdb_score=&imdb_score_max=&imdb_score_min=&lang=&lang_contains=&max_year=&min_year=&page=2&rating=&rating_contains=&sort_by=-imdb_score&title=&title_contains=&writer=&writer_contains=&year=")
    ...
    let category_3_Part2 = document.getElementById('category_3_Part2');
    ...
    for(let index=0; index<=NUMBER_OF_IMAGES; index++) {
        ...
        let a = createA();
        a.className = "button";
        a.setAttribute("href","#popup"+index+34);

        a.appendChild(createImgPopup(affiche, title));
        div.appendChild(a);
        td.appendChild(div);

        category_3_Part2.appendChild(td);
